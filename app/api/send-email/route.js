    ...
    const toEmail = agentEmails[agentName] || process.env.EMAIL_TO;
      ...
      html: `
        <div dir="rtl" style="font-family: Arial, sans-serif; max-width: 500px; margin: 0 auto; background: #f8fafc; padding: 30px; border-radius: 16px;">
          ...
          <a href="tel:${phone}"
             style="display:block; text-align:center; background: linear-gradient(135deg, #8b5cf6, #d946ef); color: white; padding: 14px 28px; border-radius: 10px; text-decoration: none; font-weight: 700; font-size: 1rem;">
            📞 התקשר עכשיו
          </a>
        </div>
      `,
